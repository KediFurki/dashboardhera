...
%>
	<tr>
		...
		<td colspan="2">
			<form id="form_week" action="Calendar.jsp" method="post">
...
%>
	<tr>
		<td style="width: 10%"></td>
		<td style="width: 40%">
			<form id="form_day_of_year" action="Calendar.jsp" method="post">
...
%>
		<td style="width: 40%">
			<form id="form_special_day" action="Calendar.jsp" method="post">
...
<div id="delete_day_of_year" class="modal">
	<div class="modal-content">
		...
		<form id="form_delete_day_of_year" action="Calendar.jsp" method="post">
...
<div id="add_day_of_year" class="modal">
	<div class="modal-content">
		...
		<form id="form_add_day_of_year" action="Calendar.jsp" method="post">
...
<div id="delete_special_day" class="modal">
	<div class="modal-content">
		...
		<form id="form_delete_special_day" action="Calendar.jsp"
			method="post">
...
<div id="change_filter" class="modal">
	<div class="modal-content">
		...
		<form id="form_change_filter" action="Calendar.jsp" method="post">
...
<div id="add_special_day" class="modal">
	<div class="modal-content">
		...
		<form id="form_add_special_day" action="Calendar.jsp" method="post">
...
<script type="text/javascript">
	...
	$(function() {
		try {
			...
			parent.ChangeActivedFooter("#Calendar","Calendar.jsp");
		} catch (e) {}

...
<body>
	<table style="width:100%; top:-3px" >
				...
				<table id="Header" class="navbar green">
					<tr>
						<td style="width: 48%" >
							<table class="left">
								<tr>
									<td><a class="green" id="ServiceGlobal" href="ServiceGlobalCCTF.jsp" target="_MainIframe">Lista Servizi</a></td>
									<td><a class="green" id="FrostEmergencyGlobal" href="FrostEmergencyGlobal.jsp" target="_MainIframe">Emergenza Gelo</a></td>
								</tr>
							</table>
						</td>
						<td style="width: 4%">
		...
		<tr>
			<td >	
				<iframe src="ServiceGlobalCCTF.jsp" id="MainIframe" name="_MainIframe" style="width: 100%;  border: 0 solid grey"></iframe>
			</td>
		</tr>
		<tr >
			<td>
						...
						<td style="width: 60%">
							<table class="left">
								<tr>
									...
									<td><a class="blue" id="TechniciansList" href="TechniciansList.jsp" target="_MainIframe">Lista Tecnici</a></td>
								</tr>
							</table>
						</td>
						<td >
	...
	<script type="text/javascript">
		...
		ChangeActiveMenu = function(menu) {
			...
			$("#FrostEmergencyGlobal").removeClass("active");
		...
		ChangeActivedFooter = function(menu,href) {
			...
			$("#TechniciansList").removeClass("active");
			if (menu != undefined) {
				$(menu).addClass("active");
				if (href != undefined) {

...
<table class="center" >
	<tr>
		...
		<td style="width: 30%">
			...
			<form id="form_day_of_year" action="CalendarCCTGlobal.jsp" method="post">
...
%>
			...
			<form id="form_special_day" action="CalendarCCTGlobal.jsp" method="post">
...
%>
		...
		<td >
			<iframe src="CalendarCCTGlobalDate.jsp" id="iFrame_CalendarGlobalDate" name="iFrame_CalendarGlobalDate" style="width: 100%; border: 0 solid grey"></iframe>
		</td>
...
<div id="delete_day_of_year" class="modal">
	<div class="modal-content">
		...
		<form id="form_delete_day_of_year" action="CalendarCCTGlobal.jsp" method="post">
...
<div id="add_day_of_year" class="modal">
	<div class="modal-content">
		...
		<form id="form_add_day_of_year" action="CalendarCCTGlobal.jsp" method="post">
...
<div id="delete_special_day" class="modal">
	<div class="modal-content">
		...
		<form id="form_delete_special_day" action="CalendarCCTGlobal.jsp" method="post">
...
<div id="add_special_day" class="modal">
	<div class="modal-content">
		...
		<form id="form_add_special_day" action="CalendarCCTGlobal.jsp" method="post">
...
<div id="change_filter" class="modal">
	<div class="modal-content">
		...
		<form id="form_change_filter" action="CalendarCCTGlobal.jsp" method="post">
...
<div id="dates" class="modal">
	<form id="form_dates" name="form_dates" action="CalendarCCTGlobalDate.jsp" method="post" target="iFrame_CalendarGlobalDate" >

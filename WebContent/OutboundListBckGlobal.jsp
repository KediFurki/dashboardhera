...
<title>OutboundListBckGlobal</title>
...
<table class="center">
	<tr>
		...
		<td style="width: 80%">
			<form id="form_without_control" action="OutboundListBckGlobal.jsp" method="post">
	...
	<div class="modal-content">
		...
		<form id="form_load_file" enctype="multipart/form-data">
			...
			<table style="width: 100%">
				...
				<tr>
					<td colspan="2">
						<label style="font-size: 12px; color:#666;">
							Formato CSV atteso (separatore <b>;</b>):<br>
							<code>contact_info;Nome_Cognome;Numero_ACT;Processo</code>
						</label>
					</td>
				</tr>
				<tr><td><br></td></tr>
				...
				<tr>
					<td colspan="2">
						<button type="button" id="Carica" class="button green" onclick="caricaOutboundListBck();">Carica</button>
					</td>						
				</tr>
			</table>
		</form>
...
<div id="Reload" class="modal">
	<form id="form_reload" action="OutboundListBckGlobal.jsp" method="post">
	</form>
</div>
...
<script>
	$(function() {
		try {
			parent.ChangeActiveMenu("#OutboundListBckGlobal");
		} catch (e) {
		}
	...
	caricaOutboundListBck = function() {
		$("#Wait").fadeIn(500);

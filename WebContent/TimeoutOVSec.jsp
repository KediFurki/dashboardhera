...
<table class="center">
	<tr>
		<td style="padding:20px; text-align:center;">
			<div class="title" style="color:#888;">Selezionare prima un servizio dalla "Lista Servizi" per visualizzare i parametri di Timeout OV Sec.</div>
		</td>
	</tr>
</table>
<%
...
<% 									// ###### ROW DEFAULT (VALORE UNIVERSALE) ###### %>
									<tr class="listGroupItem active lightblue">
										<td class="middle"><div class="title center">VALORE<br>UNIVERSALE</div></td>
<%
			for (int ip=0; ip<actPoli.length; ip++) {
				if (actPoli[ip]) {
%>

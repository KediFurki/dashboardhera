...
<%
	...
	boolean cct_a_rt = false;
	try {
		cct_a_rt = (boolean) session.getAttribute("CCT-A-RT");
	} catch (Exception ex) {
	}
%>
<body>
	<table style="width:100%; top:-3px" >
				...
				<table id="Header" class="navbar green">
					<tr>
						<td style="width: 48%" >
							<table class="left">
								<tr>
									<td><a class="green" id="ServiceGlobal" href="ServiceGlobalCCTA.jsp" target="_MainIframe">Lista Servizi</a></td>
								</tr>
							</table>
						</td>
						<td style="width: 4%">
		...
		<tr>
			<td >	
				<iframe src="ServiceGlobalCCTA.jsp" id="MainIframe" name="_MainIframe" style="width: 100%;  border: 0 solid grey"></iframe>
			</td>
		</tr>
		<tr >
			<td>

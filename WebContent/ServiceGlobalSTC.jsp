...
<%
	...
	try {
		...
		DataSource ds = (DataSource) ctx.lookup("java:/comp/env/jdbc/"+ConfigServlet.web_app+"STC");
...
<table class="center"  >
	<tr>
		...
		<td colspan="2" >
			<form id="form_emergency_1" action="ServiceGlobalSTC.jsp" method="post">
...
<%
	try {
		String firstPage = "";
		log.info(session.getId() + " - dashboard.Service_ListEx('STC')");
		cstmt = conn.prepareCall("{ call dashboard.Service_ListEx(?)}");
		cstmt.setString(1,"STC");
...
<div id="Change_Survey" class="modal">
	<form id="form_change_survey" action="ServiceGlobalSTC.jsp" method="post" >
...
<div id="Change_Priority" class="modal">
	<form id="form_change_priority" action="ServiceGlobalSTC.jsp" method="post" >
...
<div id="Modify_Emergency" class="modal">
	<div class="modal-content">
		...
		<form id="form_modify_emergency" action="ServiceGlobalSTC.jsp" method="post">

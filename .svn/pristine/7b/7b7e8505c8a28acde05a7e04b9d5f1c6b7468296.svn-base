...
<table class="center"  >
	<tr>
		...
		<td colspan="2" >
			<form id="form_emergency_1" action="ServiceGlobalCCTF.jsp" method="post">
...
<%
	try {
		String firstPage = "";
		log.info(session.getId() + " - dashboard.Service_ListEx('CCT-F')");
		cstmt = conn.prepareCall("{ call dashboard.Service_ListEx(?)}");
		cstmt.setString(1,"CCT-F");
...
<div id="Change_Survey" class="modal">
	<form id="form_change_survey" action="ServiceGlobalCCTF.jsp" method="post" >
...
<div id="Change_Priority" class="modal">
	<form id="form_change_priority" action="ServiceGlobalCCTF.jsp" method="post" >
...
<div id="Modify_Emergency" class="modal">
	<div class="modal-content">
		...
		<form id="form_modify_emergency" action="ServiceGlobalCCTF.jsp" method="post">

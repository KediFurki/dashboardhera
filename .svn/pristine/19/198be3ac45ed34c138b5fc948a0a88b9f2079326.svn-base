...
<title>OutboundListGlobal</title>
...
<div id="Reload" class="modal">
	<form id="form_reload" action="OutboundListGlobal.jsp" method="post">
	</form>
</div>
...
<script>
	$(function() {
		try {
			parent.ChangeActiveMenu("#OutboundListGlobal");			
		} catch (e) {
		}

						...
						<tr class="listGroupItem active blue ">
							<th colspan="1">
								<table style="width: 100%">
									<tr>
										<td>
											<div class="title">Agent Details <%=sFilterDay%> <%=sFilterTime %></div>
										</td>
										<td valign="top">
						...
						<td>
							...
							<table style="width: 100%">
								...
								<tr>
									...
									<td onclick="changeThreshold('TrafficDailyTot','TrafficDailyLinetech','TrafficDailyKoine','TrafficDailyVk')">%</td>
								...
								<tr>
									<td rowspan="2">LDS</td>
									<td onclick="changeThreshold('LDSTot','LDSLinetech','LDSKoine','LDSVk')">Day</td>
									<td>
										<table>
											<tr>
												<td>
								...
								<tr>
									<td rowspan="2">TMA</td>
									<td onclick="changeThreshold('TMATot','TMALinetech','TMAKoine','TMAVk')">day</td>
									<td>
										<table>
											<tr>
												<td>
								...
								<tr>
									<td onclick="changeThreshold('TMAQuarterTot','TMAQuarterLinetech','TMAQuarterKoine','TMAQuarterVk')">15'</td>
									<td>
										<table>
											<tr>
												<td>
								...
								<tr>
									<td rowspan="2">TMC</td>
									<td onclick="changeThreshold('TMCTot','TMCLinetech','TMCKoine','TMCVk')">day</td>
									<td>
										<table>
											<tr>
												<td>
								...
								<tr>
									<td onclick="changeThreshold('TMCQuarterTot','TMCQuarterLinetech','TMCQuarterKoine','TMCQuarterVk')">15'</td>
									<td>
										<table>
											<tr>
												<td>
								...
								<tr>
									...
									<td onclick="changeThreshold('DistributedTot','DistributedLinetech','DistributedKoine','DistributedVk')">day</td>
									<td>
										<table>
											<tr>
												<td>
								...
								<tr>
									<td onclick="changeThreshold('DistributedQuarterTot','DistributedQuarterLinetech','DistributedQuarterKoine','DistributedQuarterVk')">15'</td>
									<td>
										<table>
											<tr>
												<td>
		...
		<div class="modal-content">
			<div class="modal-header blue">
				<table style="width: 100%">
					<tr>
						<td>
							<h2>Cambia Data di Visualizzazione</h2>
						</td>
						<td>
			...
			<form id="form_change_filter" action="AgentDetails.jsp" method="post">
				...
				<table>
					...
					<tr>
						<td>
							<label for="change_filter_day">Giorno</label>
						</td>
						<td>
							<input type="date" id="change_filter_day" name="change_filter_day">
						</td>
						<td>
							<input type="time" id="change_filter_time" name="change_filter_time" value="<%=sFilterTime%>">
						</td>
						<td>
							<button type="button" class="buttonsmall blue" onclick="$('#change_filter_day').val('<%=sdf_full_day_of_year.format(filterToday)%>'); $('#change_filter_time').val('<%=sdf_time.format(filterToday)%>')">Oggi</button>
						</td>
					</tr>
					<tr>
						<td>
...
<div id="change_Threshold" class="modal">
	<div class="modal-content"  style="width: 830px">
		...
		<form id="form_change_filter" action="AgentDetailsHistory.jsp" method="post">
	...
	<%}%>
		...
		function DistributedQuarterLinetechChange(_this) {
			try {
				...
				var result = parseFloat(_this.innerHTML) /	<%=DistributedQuarterForecastLinetech%>		;
				result = (Math.round(result * 1000) / 10 );
		...
		try {
			...
			JSONArray ja = DBUtility.getStatisticsValue(SystemEnvironment, CodIvr, cal.getTime());

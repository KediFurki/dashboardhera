...
<%
	...
	boolean cct_e_rt = false;
	try {
		cct_e_rt = (boolean) session.getAttribute("CCT-E-RT");
	} catch (Exception ex) {
	}
%>
<body>
	<table style="width:100%; top:-3px" >
				...
				<table id="Header" class="navbar green">
					<tr>
						<td style="width: 48%" >
							<table class="left">
								<tr>
									<td><a class="green" id="ServiceGlobal" href="ServiceGlobalCCTE.jsp" target="_MainIframe">Lista Servizi</a></td>
									<td><a class="green" id="NoRecListGlobal" href="NoRecListGlobal.jsp" target="_MainIframe">Liste</a></td>
									<td><a class="green" id="PesseGlobal" href="PesseGlobal.jsp" target="_MainIframe">Pesse</a></td>
									<td><a class="green" style="display:none" id="SurveyWeb" href="SurveyWeb.jsp" target="_MainIframe">Gestione Survey Web</a></td>
								</tr>
							</table>
						</td>
						<td style="width: 4%">
						...
						<td>
							...
							<div class="right"><a class="pink bold" id="ServiceDetails" href="SetEmergency.jsp" target="_MainIframe" class='title1'><%=descService %></a></div>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td >	
				<iframe src="ServiceGlobalCCTE.jsp" id="MainIframe" name="_MainIframe" style="width: 100%;  border: 0 solid grey"></iframe>
			</td>
		</tr>
		<tr >
			<td>
						...
						<td style="width: 60%">
							<table class="left">
								<tr>
									...
									<td><a class="blue" id="LivelloPesse" href="LivelloPesse.jsp" target="_MainIframe">Livello Pesse</a></td>
									<td><a class="blue" id="SwitchCCT" href="SwitchCCT.jsp" target="_MainIframe">Switch</a></td>
								</tr>
							</table>
						</td>
						<td >
							...
							<table class="right" >
								<tr>
									<td><a class="blue" id="RealTimeTraffic" href="RealTimeTraffic.jsp" target="_MainIframe">Traffico RealTime</a></td>
								</tr>
							</table>
							<%} %>
						</td>
	...
	<script type="text/javascript">
		...
		ChangeActiveMenu = function(menu) {
			...
			$("#NoRecListGlobal").removeClass("active");
			$("#PesseGlobal").removeClass("active");
		...
		ChangeActivedFooter = function(menu,href) {
			...
			$("#RealTimeTraffic").removeClass("active");
			
			$("#SetEmergency").removeClass("active");
			$("#Survey").removeClass("active");
			$("#LivelloPesse").removeClass("active");
			$("#SwitchCCT").removeClass("active");
			if (menu != undefined) {
				$(menu).addClass("active");
				if (href != undefined) {

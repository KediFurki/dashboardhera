...
<body>
					...
					<tr>
						<td style="width: 48%" >
							<table class="left">
								<tr>
									<td>
										<a class="green" id="ServiceGlobal" href="ServiceGlobalCCTE.jsp" target="_MainIframe">Lista Servizi</a>
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							...
							<div class="right"><a class="pink bold" id="ServiceDetails" href="MapEsigenze.jsp" target="_MainIframe" class='title1'><%=descService %></a></div>
						</td>
					</tr>
				</table>
			</td>
					...
					<tr>
						<td style="width: 60%">
							<table class="left">
								<tr>
									<td>
										<a class="blue" id="MapEsigenze" href="MapEsigenze.jsp" target="_MainIframe">Associazione Nodi Esigenze</a>
									</td>
								</tr>
							</table>
						</td>
	...
	<script type="text/javascript">
		...
		ChangeActivedFooter = function(menu,href) {
			...
			$("#MapEsigenze").removeClass("active");
			if (menu != undefined) {
				$(menu).addClass("active");
				if (href != undefined) {

...
@WebServlet("/UploadDownloadSetEmergency")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 150, // 10 MB
	maxFileSize = 1024 * 1024 * 150, // 50 MB
	maxRequestSize = 1024 * 1024 * 300) // 100 MB

public class UploadDownloadSetEmergency extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UploadDownloadSetEmergency() {
		super();
	}
			...
			case "play":
				...
				try {
					...
					case "CCT-F":
						...
						break;
					case "CCT-E":
						aMessageDestination = Utility.GetSystemParameters(session, Utility.IT_CCTE);
						break;
					case "CCT-A":
						aMessageDestination = Utility.GetSystemParameters(session, Utility.IT_CCTA);
						break;
					case "STC":
						aMessageDestination = Utility.GetSystemParameters(session, Utility.IT_STC);
						break;
					}
